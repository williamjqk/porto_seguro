...
model_name = 'porto_seguro_dae025'
...
train_filename = os.path.join(data_path, 'train_rankgauss_porto_seguro_dae00x2.tfrecord')
test_filename = os.path.join(data_path, 'test_rankgauss_porto_seguro_dae00x2.tfrecord')
n_records = sum(1 for _ in tf.python_io.tf_record_iterator(train_filename))
n_records += sum(1 for _ in tf.python_io.tf_record_iterator(test_filename))
