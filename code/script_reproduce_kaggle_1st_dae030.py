...
# model_name = 'porto_seguro_dae020b'
model_name = 'porto_seguro_dae030'
nn_params = {
    "layers": [1000, 1000],
...
def standard_layer(input_layer, n_nodes, std, keep_rate, bn_phase, layer_name, l2_scale, vscope_name=None):
