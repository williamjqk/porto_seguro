...
sess.run([dae_h1, dae_h2, dae_h3]) # cannot work there is a 'import/' prefix before node names
...
x1,x2,x3 = sess.run([dae_h1, dae_h2, dae_h3], feed_dict={tf_x1: np.ones([20,221]), traing_phase: False})
print(x1,x2,x3)
